...
class DailyAdapter (private val dailyList: ArrayList<Daily>,private val activity: Activity)  : RecyclerView.Adapter<DailyAdapter.DailyViewHolder>()  {
     var lang:String
     var unit:String
   ...
   lateinit var tempUnit:String
    ...
    override fun onBindViewHolder(holder: DailyAdapter.DailyViewHolder, position: Int) {
        ...
        var dayName=calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale(lang)).toString()
        ...
        if(lang.equals("en")) {
            ...
            holder.binding.tempTxt.text = convertToArabic(max) + tempUnit + " : " + convertToArabic(min) + tempUnit
