...
class FavoriteAdapter (private val favoriteList: ArrayList<WeatherResponse>,private val context:Context?,private  var favoriteViewModel:FavoriteViewModel)  : RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>()  {
    var lang:String
